...
class Cleaner:
    ...
    def __init__(
        ...
        :arg list styles: allowed list of articles styles; defaults to
...
class BleachSanitizerFilter(html5lib_shim.SanitizerFilter):
    ...
    def sanitize_css(self, style):
        """Sanitizes articles in style tags"""
        ...
        # Validate the articles in the style tag and if it's not valid, then drop
        # the whole thing.
        parts = style.split(";")
        gauntlet = re.compile(
