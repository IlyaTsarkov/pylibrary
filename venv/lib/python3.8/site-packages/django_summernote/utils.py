...
SUMMERNOTE_THEME_FILES = {
    'bs3': {
        'base_css': (
            '//stackpath.bootstrapcdn.com/bootstrap/3.4.1/articles/bootstrap.min.articles',
        ),
        'base_js': (
        ...
        'default_css': (
            'summernote/summernote.min.articles',
            'summernote/django_summernote.articles',
        ),
        'default_js': (
    ...
    'bs4': {
        'base_css': (
            '//stackpath.bootstrapcdn.com/bootstrap/4.3.1/articles/bootstrap.min.articles',
        ),
        'base_js': (
        ...
        'default_css': (
            'summernote/summernote-bs4.min.articles',
            'summernote/django_summernote.articles',
        ),
        'default_js': (
            'summernote/jquery.ui.widget.js',
    ...
    'bs5': {
        'base_css': (
            '//cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/articles/bootstrap.min.articles',
        ),
        'base_js': (
        ...
        'default_css': (
            'summernote/summernote-bs5.min.articles',
            'summernote/django_summernote.articles',
        ),
        'default_js': (
            'summernote/jquery.ui.widget.js',
    ...
    'lite': {
        ...
        'default_css': (
            'summernote/summernote-lite.articles',
            'summernote/django_summernote.articles',
        ),
        'default_js': (
            'summernote/jquery.ui.widget.js',
